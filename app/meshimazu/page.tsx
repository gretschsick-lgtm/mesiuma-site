...
export const metadata: Metadata = {
  title: "メシマズ店舗取材一覧",
  description: "メシウマ稼働が実際に取材・調査したメシマズ認定店舗の一覧。各店舗の取材レポート・動画・調査結果をまとめて確認。",
  keywords: ["メシマズ","店舗取材","パチスロ","調査","レポート","メシウマ稼働","認定店舗","取材一覧"],
  openGraph: {
    title: "メシマズ店舗取材一覧 | メシウマ稼働",
    description: "メシウマ稼働が実際に取材・調査したメシマズ認定店舗の一覧と取材レポート。",
