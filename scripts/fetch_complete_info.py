...
COMPLETE_QUERIES = [
    ...
    # ══ 【新規追加機種 2026-06】 ══
    "ヴヴヴ2 コンプリート 番台",
    "e女神のカフェテラス コンプリート 番台",
    "e閃乱カグラ コンプリート 番台",
    "東京喰種W コンプリート 番台",
    "牙狼12黄金騎士極限 コンプリート 番台",
    "スマスロ ミリオンゴッド コンプリート 番台",
    "モンハンライズ コンプリート 番台",
    "リコリス・リコイル コンプリート 番台",
    "ダンベル コンプリート 番台",
    "L革命機ヴァルヴレイヴ コンプリート 番台",
    # ── 実績確認済み追加分 (2026-06-04) ──
    "ひきこまり コンプリート 番台",
    "東京リベンジャーズ コンプリート 番台",
    "無職転生 コンプリート 番台",
    "ビッグドリーム コンプリート 番台",
    ...
    "一騎当千 コンプリート 番台",
    "番長 コンプリート 番台",
    # ── エヴァンゲリオン系（e新世紀エヴァンゲリオン/eエヴァ17はじまりR 実績確認済み 2026-06-05）──
    "エヴァ コンプリート 番台",
    "エヴァンゲリオン コンプリート 番台",

    # ══ 【機種完全名クエリ】complete_info.json 実績機種の正式名称（2026-06-05追加）══
    "L革命機ヴァルヴレイヴ2 コンプリート 番台",
    "スマスロ北斗の拳転生の章2 コンプリート 番台",
    "e牙狼12黄金騎士極限 コンプリート 番台",
    "Lミリオンゴッド神々の軌跡 コンプリート 番台",
    "e牙狼12 コンプリート 番台",
    "L東京喰種 コンプリート 番台",
    "eフィーバーキン肉マン コンプリート 番台",
    "L炎炎ノ消防隊2 コンプリート 番台",
    "Lチバリヨ2ZB コンプリート 番台",
    "スマスロ攻殻機動隊 コンプリート 番台",
    "Lかぐや様は告らせたい コンプリート 番台",
    "eバイオハザード6 コンプリート 番台",
    "e東京喰種 コンプリート 番台",
    "eカケグルイ コンプリート 番台",
    "L甲鉄城のカバネリ海門決戦 コンプリート 番台",
    "スマスロゴッドイーター コンプリート 番台",
    "スマスロバイオハザードRE:3 コンプリート 番台",
    "L沖ドキDUO アンコール コンプリート 番台",
    "スマスロ北斗の拳 コンプリート 番台",
    "Lからくりサーカス コンプリート 番台",
    "eリコリス・リコイル コンプリート 番台",
    "L真打吉宗 コンプリート 番台",
    "スマスロ リコリス・リコイル コンプリート 番台",
    "e新世紀エヴァンゲリオン コンプリート 番台",
    "eエヴァ17はじまりR コンプリート 番台",
    "eひきこまり吸血姫の悶々 コンプリート 番台",
    "スマスロ バイオハザード5 コンプリート 番台",
    "いざ！番長 コンプリート 番台",
    "スマスロ賭ケグルイ コンプリート 番台",
    "スマスロ モンスターハンターライズ コンプリート 番台",
    "L吉宗 コンプリート 番台",
    "LタクトオーパスM1 コンプリート 番台",
    "スロット ゾンビランドサガ コンプリート 番台",
    "Lシャーマンキング コンプリート 番台",
    "Lビッグドリーム コンプリート 番台",
    "スマスロ 東京リベンジャーズ コンプリート 番台",
    "スマスロ 化物語 コンプリート 番台",
    "L新鬼武者3 コンプリート 番台",
    "L 真・一騎当千 コンプリート 番台",
    "チバリヨ2 コンプリート 番台",
    "女神のカフェテラス コンプリート 番台",
    "スマスロ ミリオンゴッド-神々の軌跡- コンプリート 番台",
    "Lモンキーターン コンプリート 番台",
    "L無職転生～異世界行ったら本気だす～ コンプリート 番台",
    "L戦国乙女4 コンプリート 番台",
    "Lアズールレーン2 コンプリート 番台",
    "L鉄拳6 コンプリート 番台",

    # ══ 【機種完全名 × コンプリート機能発動】上位13機種 ══
    "L革命機ヴァルヴレイヴ2 コンプリート機能発動",
    "スマスロ北斗の拳転生の章2 コンプリート機能発動",
    "e牙狼12黄金騎士極限 コンプリート機能発動",
    "Lミリオンゴッド神々の軌跡 コンプリート機能発動",
    "e牙狼12 コンプリート機能発動",
    "L東京喰種 コンプリート機能発動",
    "eフィーバーキン肉マン コンプリート機能発動",
    "L炎炎ノ消防隊2 コンプリート機能発動",
    "Lチバリヨ2ZB コンプリート機能発動",
    "スマスロ攻殻機動隊 コンプリート機能発動",
    "Lかぐや様は告らせたい コンプリート機能発動",
    "eバイオハザード6 コンプリート機能発動",
    "e東京喰種 コンプリート機能発動",

    # ══ 【実績チェーン追加】complete_info.json 実績確認済みチェーン ══
    "フェイス コンプリート 番台",          # フェイス系 38件実績
    "フェイス コンプリート機能発動",
    "メガフェイス コンプリート 番台",       # メガフェイス 31件実績
    "メガフェイス コンプリート機能発動",
    "キクヤ コンプリート 番台",             # キクヤ 17件実績
    "D'station コンプリート 番台",         # D'station 13件実績
    "Dステーション コンプリート 番台",
    "テキサス コンプリート 番台",           # テキサス 13件実績
    "MJアリーナ コンプリート 番台",         # MJアリーナ 9件実績
    "玉屋 コンプリート 番台",               # 玉屋 8件実績
    "ARROW コンプリート 番台",              # ARROW 7件実績
    "キング観光 コンプリート 番台",          # キング観光 7件実績
    "SPACE コンプリート 番台",              # SPACE系 5件実績
    "ユーコーラッキー コンプリート 番台",    # ユーコー 5件実績
    "ニラク コンプリート 番台",              # ニラク 3件実績
    "スタジアム コンプリート 番台",          # スタジアム 3件実績
    "やすだ コンプリート 番台",              # やすだ 3件実績
    "123 コンプリート 番台",                # 123 3件実績
    "アミューズ コンプリート 番台",
    "楽園 コンプリート機能発動",
    "ガーデン コンプリート機能発動",
    "マルハン コンプリート おめでとうございます",
    "キコーナ コンプリート機能発動",
    "ワンダーランド コンプリート機能発動",
    "キャッスル コンプリート機能発動",
    "ダイナム コンプリート 達成",
    "アビバ コンプリート 番台",
    "D'station コンプリート機能発動",
    "テキサス コンプリート機能発動",
    "キクヤ コンプリート機能発動",
    "MJアリーナ コンプリート機能発動",
    "玉屋 コンプリート機能発動",
    "ARROW コンプリート機能発動",
    "フェイス コンプリート おめでとうございます",
    "メガフェイス コンプリート おめでとうございます",
    "キング観光 コンプリート機能発動",

    # ══ 【機種短縮バリアント】実績機種の別称・略称 ══
    "革命機ヴァルヴレイヴ2 コンプリート 番台",
    "ヴァルヴレイヴ2 コンプリート 番台",
    "北斗の拳転生 コンプリート 番台",
    "北斗転生の章2 コンプリート 番台",
    "牙狼12極限 コンプリート 番台",
    "牙狼12黄金騎士 コンプリート 番台",
    "ミリオンゴッド神々の軌跡 コンプリート 番台",
    "Lミリオンゴッド コンプリート 番台",
    "フィーバーキン肉マン コンプリート 番台",
    "eキン肉マン コンプリート 番台",
    "L炎炎2 コンプリート 番台",
    "チバリヨ2ZB コンプリート 番台",
    "Lチバリヨ2 コンプリート 番台",
    "スマスロ攻殻 コンプリート 番台",
    "かぐや様は告らせたい コンプリート 番台",
    "カケグルイ コンプリート 番台",
    "L沖ドキDUO コンプリート 番台",
    "沖ドキDUO アンコール コンプリート 番台",
    "甲鉄城のカバネリ コンプリート 番台",
    "eリコリコ コンプリート 番台",
    "真打吉宗 コンプリート 番台",
    "ひきこまり吸血姫 コンプリート 番台",
    ...
    "コンプリート機能 全解除 番台",
    "コンプリート機能 全消灯 番台",
    "本日 コンプリート おめでとうございます",
    "全台コンプリート スマスロ",
    "スマスロコンプリート 番台",
    "コンプリート達成 おめでとうございます filter:media",
    "コンプリート機能発動 おめでとう filter:media",
    "#コンプリート機能 番台",
    "コンプリート機能 発動 番台",
    "スマスロ コンプリート 機能発動",
    "#スマスロ コンプリート機能発動",
    "コンプリート おめでとう 番台",
    "スマスロ 完走 番台",
    "コンプリート達成 filter:media 番台",
    "パチスロ コンプリート機能発動 番台",
    "17000枚 番台",
    "16000枚 番台",
    "22000枚 番台",
    "G松原 コンプリート 番台",            # G松原 4件実績
    "楽園池袋 コンプリート 番台",           # 楽園池袋 14件実績
    "キャッスル熱田 コンプリート 番台",     # キャッスル熱田 11件実績
    "キャッスル春日井 コンプリート 番台",   # キャッスル春日井 7件実績
    "マルハン仙台 コンプリート 番台",       # マルハン仙台 8件実績
    "スマスロ北斗転生 コンプリート 番台",
    "L革命機ヴァルヴレイヴ コンプリート 発動",

    # ══ 【追加機種達成バリアント】top機種 × コンプリート達成 ══
    "L革命機ヴァルヴレイヴ2 コンプリート達成",
    "スマスロ北斗の拳転生の章2 コンプリート達成",
    "e牙狼12黄金騎士極限 コンプリート達成",
    "Lミリオンゴッド神々の軌跡 コンプリート達成",
    "e牙狼12 コンプリート達成",
    "L東京喰種 コンプリート達成",
    "eフィーバーキン肉マン コンプリート達成",
    "L炎炎ノ消防隊2 コンプリート達成",
    "Lチバリヨ2ZB コンプリート達成",
    "スマスロ攻殻機動隊 コンプリート達成",
    ...
    "ビックマーチ コンプリート機能発動",
    "コンコルド コンプリート機能発動",
    "ARROW コンプリート おめでとうございます",
    "テキサス コンプリート おめでとうございます",
    "キング観光 コンプリート おめでとうございます",
    "楽園 コンプリート 達成 番台",
    "ガーデン コンプリート 達成 番台",
    ...
    "コンプリート 全機種 番台",
    "コンプリート機能 達成 番台",
    "パチスロ コンプリート おめでとうございます 番台",
    "スマスロ コンプリート おめでとう",
    "コンプ機能 発動 番台",
    "コンプリート機能 発動 おめでとうございます 番台",
    "L革命機 コンプリート 番台",
    "スマスロ コンプリート フィーバー",
    "コンプリート 達成 おめでとうございます スロット",
]
...
MACHINE_PATTERNS = [
    ...
    # スマスロ 機種名 形式（スマパチはpreprocessで e prefix変換済み — ここには含めない）
    # 「の」をlookaheadから除外: 「北斗の拳転生の章2」で「の」に引っかかる誤り防止
    re.compile(r'(?:スマスロ|Lパチスロ|パチスロ)\s*[　]?([^\s　\n#「」【】、。]{3,25}?)(?=\s*(?:にて|で|が|コンプ|達成|機能|\n|$|\d+番台))'),
    # L北斗の拳転生（汎用Lパターンは「の」で早期停止するため先に専用パターンを置く）
    re.compile(r'([LＬ]北斗の拳[　\s]*転生(?:の章[２2Ⅱ]?)?)'),
    # L機種名（半角・全角両対応 — プレフィックス込みでキャプチャ）
    # 「の」をlookaheadから除外: 「L甲鉄城のカバネリ」で「の」に引っかかる誤り防止
    re.compile(r'([LＬ][^\s　\n#「」【】、。]{2,19}?)(?=\s*(?:にて|で|が|コンプ|達成|機能|\n|$|\d+番台|』|」|】))'),
    # e機種名 バージョン番号 にて形式（スマパチ→e変換後の eカケグルイ 219ver にて等）
    re.compile(r'([eｅ][^\s　\n#「」【】、。（(』]{2,15})\s+\d{2,5}[Vvｖ][Ee][Rr]?\S{0,5}(?=\s*(?:にて|で|コンプ|達成|機能))'),
    # e機種名（プレフィックス込み — 『e機種名』・【e機種名】・e機種名\s全形式対応）
    # 「の」をlookaheadから除外（e機種の場合はeプレフィックスで型が確定するため不要）
    re.compile(r'([eｅ][^\s　\n#「」【】、。（(』]{2,19}?)(?=\s*(?:にて|で|が|コンプ|達成|機能|\n|$|（|\d+番台|』|」|】))'),
    ...
    re.compile(r'(甲鉄城のカバネリ海門決戦)'),   # フルネーム先行マッチ
    re.compile(r'(カバネリ海門決戦)'),
    re.compile(r'(カバネリ[^\s　\n#「」【】、。！!]{0,10})'),
    re.compile(r'([LＬ]?モンキーターン[^\s　\n#「」【】、。！!]{0,5})'),
...
_SLOT_KEYWORDS = [
    "スマスロ", "Lパチスロ", "パチスロ", "ヴァルヴレイヴ", "ミリオンゴッド",
    "攻殻機動隊", "カバネリ", "バジリスク",
    "モンスターハンター", "ゾンビランドサガ", "ジャグラー",
    "チバリヨ", "吉宗", "鉄拳", "まどマギ", "鬼武者", "エウレカ",
    "Re:ゼロ", "転スラ", "バイオハザード", "ブルーロック",
    # 「炎炎ノ消防隊」「からくりサーカス」は slot/pachinko 両方に存在するため除外
    # 「東京喰種」「リコリス」「北斗」は slot/pachinko 両方に存在するため除外
    # → prefix なし入力は get_machine_type() でデフォルト slot ではなく
    #   machine_resolver が unknown_machines に送る設計
]
...
def extract_machine(text: str) -> str:
    ...
    # カバネリ 海門決戦（スペース区切り）→ 結合（例: "甲鉄城のカバネリ 海門決戦" → "甲鉄城のカバネリ海門決戦"）
...
def update_ranking():
    ...
    MACHINE_NAME_NG = {
        ...
        # 今回追加: 抽出ゴミ
        "から", "がお見事", "にて", "er", "コンプおめ", "＋9000枚", "ＬＥＴＥ",
        "から...", "𝟡𝟝,𝟘𝟘𝟘玉",
    }
    ...
    MACHINE_NORMALIZE: list[tuple[str, str]] = [
        ...
        # L炎炎ノ消防隊2（prefix 付きのみ保持。prefix なし → AMBIGUOUS_SERIES で unknown_machines 送り）
        ("Ｌ炎炎ノ消防隊２",      "L炎炎ノ消防隊2"),
        # 「炎炎ノ消防隊」「炎炎の消防隊」等 prefix なしは L炎炎(slot) と e炎炎/eフィーバー炎炎(pachinko) 両方存在
        # → MACHINE_NORMALIZE から除外。machine_resolver の AMBIGUOUS_SERIES で unknown_machines 送り
        # Lミリオンゴッド神々の軌跡
        ...
        ("カバネリ",                  "L甲鉄城のカバネリ海門決戦"),
        ("甲鉄城",                    "L甲鉄城のカバネリ海門決戦"),
        # 「東京喰種」「北斗の拳」「北斗」はプレフィックスなしで slot/pachinko 両方存在
        # → MACHINE_NORMALIZE から除外。machine_resolver の AMBIGUOUS_SERIES で unknown_machines 送り
        # スマスロ北斗の拳（転生パターンは上で処理済み。prefix なし "北斗" は除外）
        # スマスロ攻殻機動隊
        ("攻殻機動隊",             "スマスロ攻殻機動隊"),
        # バジリスク絆2
        ("バジリスク絆２",         "バジリスク絆2"),
        ...
        ("転スラ",                     "e転生したらスライムだった件2"),
        # 「からくりサーカス」prefix なしは Lからくりサーカス(slot) と Pフィーバーからくりサーカス(pachinko) 両方存在
        # → MACHINE_NORMALIZE から除外。machine_resolver の AMBIGUOUS_SERIES で unknown_machines 送り
        # L鉄拳6（「鉄拳6から一撃」等の余分なテキストは extract_machine で除去済）
        ("鉄拳6",                      "L鉄拳6"),
        ("鉄拳",                       "L鉄拳6"),
        # モンキーターン系（LモンキーターンとモンキーターンVは別機種）
        ("LモンキーターンV",            "LモンキーターンV"),   # identity: 別機種保護
        ("Lモンキーターン",             "Lモンキーターン"),    # identity
        ("モンキーターンV",             "モンキーターンV"),    # identity
        ("モンキーターン",              "Lモンキーターン"),    # プレフィックスなし → Lモンキーターン
    ]
