#!/usr/bin/env python3
# =============================================================================
# ⚠️  このスクリプトは現在使用しません（STEP 4 画像取得廃止 2026-05）
#
# 廃止理由:
#   - X / Twitter 投稿の画像は転載禁止のためフロントエンドでの表示を廃止
#   - GitHub Actions (update_events.yml) からの呼び出しも削除済み
#   - image_url フィールドは JSON に残るが、フロントエンド・Supabase いずれも
#     このフィールドを無視する（表示・送信しない）
#
# 将来また使う場合は、このコメントブロックを削除して GitHub Actions に追記すること。
# =============================================================================
"""
